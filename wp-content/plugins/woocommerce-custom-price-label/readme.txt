...
WooCommerce Custom Price Label Plugin lets you add any price label to any WooCommerce product.
Labels can be set **globally** for all products, or locally on **per product** basis.
You can also use included **bulk price labels editor tool** to modify multiple product's labels.
...
= More =
* Visit the [WooCommerce Custom Price Label plugin page](http://coder.fm/item/woocommerce-custom-price-label-plugin/)
...
You need [WooCommerce Custom Price Label Pro plugin](http://coder.fm/item/woocommerce-custom-price-label-plugin/) to change these settings.
