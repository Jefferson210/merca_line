...
class Mediaphase_Feature_Widget extends WP_Widget
{
	...
	public function form( $instance )
	{
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'url' ); ?>"><?php _e( 'URL:', 'mediaphase' ); ?></label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Icon (see <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">this link</a> for reference):' ); ?></label>
