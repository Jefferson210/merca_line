<div id="poststuff">
    ...
    <form id="panel-form">
        ...
        <?php  foreach ( $options as $box_id => $option ):
            if ( isset( $option['post_types'] ) && $current_panel['model'] == 'post_type' && ! in_array( $current_panel['type'], (array) $option['post_types'] ) ) {
                continue;
            }
            ?>
            <div id="<?php echo $box_id ?>" class="postbox">
                ...
                <div class="inside">
                    ...
                    foreach ( $option['fields'] as $id_tab => $field ) :
                        if ( isset( $field['post_types'] ) && $current_panel['model'] == 'post_type' && ! in_array( $current_panel['type'], (array) $field['post_types'] ) ) {
                            continue;
                        }
