...
/**
 * Remove free unused framework modules
 */
function yit_free_unset_theme_modules( $modules ){
    unset( $modules['feature-tabs'] );
    unset( $modules['portfolio'] );
    unset( $modules['slider'] );
...
add_filter( 'yit_framework_modules', 'yit_free_unset_theme_modules' );
