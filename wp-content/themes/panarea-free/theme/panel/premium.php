...
$premium_theme_name = 'panarea';

$yithemes_landing = 'https://yithemes.com/themes/wordpress/panarea-restaurant-and-food-wordpress-theme/';

$name = 'Panarea - Restaurant and Food wordpress theme';
...
<div class="container bolder-tpl landing">
    ...
    <ul class="premium-features">
        ...
        <li>
            <img src="<?php echo $images_url ?>/sample-data.png" alt="<?php echo $name ?>" />
        ...
        <li>
            <img src="<?php echo $images_url ?>/compare.png" alt="<?php echo $name ?>" />

            <h3>COMPARE PRODUCTS</h3>

            <p>
                Allows to users to compare more products of your shop in one complete table.
            </p>
        </li>

        <li>
            <img src="<?php echo $images_url ?>/portfolio.png" alt="<?php echo $name ?>" />

            <h3>FILTERABLE PORTFOLIO</h3>

            <p>
                Show your projects with an elegant style and let the users flirt them following certain search parameters.
            </p>
        </li>
